...
NMap.onLoad(function() {
  ...
  center.addEventListener('click', function() {
    marker.target.setPosition(new qq.maps.LatLng(31.22151715979285, 121.40951189046687))
  });
  realCenter.addEventListener('click', function() {
    var a = polygon.getInnerPoint().getCoordinate()
    marker.target.setPosition(new qq.maps.LatLng(a.x, a.y))
    // var x = [];
