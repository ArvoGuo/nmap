...
NMap.onLoad(function() {
  ...
  var centerPoint = new qq.maps.LatLng(31.259928358250843, 121.44005798879533);
  ...
  var circle = NMap.create('Circle', {
    center: centerPoint,
    radius: 1000,
    // fillColor: color.toHex('#47C370', 0.4),
    // strokeColor: color.toHex('#47C370', 0.8),
    // strokeWeight: 1,
    // zIndex: 1
  })
